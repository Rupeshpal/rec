  ...
  <div className="flex justify-between items-start mt-10 gap-3">
    ...
    <div className="w-full" ref={printRef}>
      ...
      <div className="p-4 space-y-4">
        ...
        Detailed Information
          ...
          <div>
          <select name="Regliion" id=""   className="w-full border border-gray-300 p-1 rounded-md bg-white">
    ...
    <div className="w-[60%]">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <select name="
        " id=""  className="w-full border border-gray-300 p-1 rounded-md bg-white">
         <option disabled value="">Charge Category</option>
       ...
       <div>
         <select name="" id="" className="w-full border border-gray-300 p-1 rounded-md bg-white">
           <option disabled value="">Discount Scheme</option>
       ...
       <div>
       <h2 className="text-xl font-semibold bg-teal-700 text-white w-30 py-2 w-full text-center">
         Net Payable 👉
      </h2>
       </div>
