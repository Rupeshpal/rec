      ...
      <div className="bg-gray-200 p-4 mt-2">
        ...
        <div className="bg-white border mt-4">
          ...
          <div className="grid grid-cols-4 p-2 gap-7">
            ...
            <option value="">MVH</option>
            <option value="">MCH</option>
          </select>
            </div>
            <div>
            <h5>Test Parameter Name *</h5>
            <input readOnly className=" p-2 border rounded" />
            </div>
            <div>
            <h5>Test Parameter Name *</h5>
            <input readOnly className=" p-2 border rounded" />
            ...
            <div className="mt-6">
            <button className=" bg-teal-700  h-[2.5rem] text-white w-[8rem] rounded px-2">+</button>
            </div>
          </div>
        </div>
